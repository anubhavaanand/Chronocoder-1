...
**Vulnerability:** The Streamlit application had hardcoded admin passwords in `main.py` and `anubhav_admin.py`, allowing anyone to gain unrestricted admin access if they view the source code.
